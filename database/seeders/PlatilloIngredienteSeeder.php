...
class PlatilloIngredienteSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        PlatilloIngrediente::create(['platillo_id' => 1, 'ingrediente_id' => 8]);
        PlatilloIngrediente::create(['platillo_id' => 1, 'ingrediente_id' => 9]);
        ...
        PlatilloIngrediente::create(['platillo_id' => 3, 'ingrediente_id' => 2]);
        PlatilloIngrediente::create(['platillo_id' => 3, 'ingrediente_id' => 7]);
        PlatilloIngrediente::create(['platillo_id' => 3, 'ingrediente_id' => 2]);
        PlatilloIngrediente::create(['platillo_id' => 4, 'ingrediente_id' => 5]);
